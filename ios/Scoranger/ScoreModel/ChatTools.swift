...
enum ChatTools {
    ...
    static let all: [Spec] = [
        ...
        Spec(name: "move_element",
             ...
             parameters: params(["part": str("the part the element is on"),
                                 "kind": str("harm, diagram, dynamic, text, fermata, articulation or ornament"),
