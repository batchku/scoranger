...
struct LocalChat {
    ...
    private static let tools: [ToolSpec] = [
        ...
        ToolSpec(name: "respell",
                 description: "Respell accidentals enharmonically: prefer='flats' turns G# into Ab (right for flat keys like F minor); prefer='sharps' does the reverse. Key signatures untouched.",
